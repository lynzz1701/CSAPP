...
# Description:
# Similiar to PartB.
# iaddl: add the value in register and a constant number, result will be stored in the original register.

# Modification list:
# --fetch stage:
#     --"Is instrucation valid"? 
#        add IIADDL to the tuple to make it valid
#     --"Does fetched instruction require a regid byte?"
#        one of the operand is register value, so add IIADDL here
#     --"Does fetched instruction require a constant word?"
#        one of the operand is immediate number, so add IIADDL here
# --decode stage:
#     --"What register should be used as the B source?"
#        register ID saved in D_rB, add IIADDL to {..}:D_rB
#     --"What register should be used as the E destination?"
#        result saved in the original register, add IIADDL to {..}:D_rB
# --execute stage:
#     --"Select input A to ALU"
#        constant number saved in E_valC, add IIADDL to {..}:E_valC
#     --"Select input B to ALU"
#        register value saved in E_valB, add IIADDL to {..}:E_valB 
#     --"Should the condition codes be updated?"
#        yes, updated for iaddl, join IIADDL with IOPL to form a tuple
# --memory stage:
...
#############################
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL,IIADDL, 
...
#############################
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, IIADDL,
